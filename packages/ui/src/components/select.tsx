...
/**
 * Select - Radix Select primitive (S46 W3, shadcn full composition).
 * WCAG 2.1 AA: keyboard nav (arrows + Home/End + type-ahead), screen reader announces options,
 * focus management on open/close. Portal-rendered popover.
 *
 * Composition pattern: <Select><SelectTrigger><SelectValue/></SelectTrigger>
